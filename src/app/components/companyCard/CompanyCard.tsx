...
const CompanyCard = ({content}:CompanyCardProps) => {
    return (
        ...
        <div className="flex flex-col relative rounded-xl text-black border-2 border-opacity-50 overflow-hidden min-h-[376px] shadow-lg">
            <Image className="min-h-[220px] max-h-[220px] object-cover w-full rounded-lg" src={content.companyImage} alt={"benefit-img"} width={380} height={257} />
